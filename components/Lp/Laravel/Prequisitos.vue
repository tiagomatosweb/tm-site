...
<script setup>
import IconPhp from '~/components/Icon/Php.vue';
import IconHtml5 from '~/components/Icon/Html5.vue';
import IconCss3 from '~/components/Icon/Css3.vue';
import IconTerminal from '~/components/Icon/Terminal.vue';
